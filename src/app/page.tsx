...
export default function Home() {
  return (
      <div className="flex p-20 bg-[#419E5B]/10 justify-between">
        
        <div className="w-1/3 space-y-10">  
          <div className="w-fit text-xs px-4 py-0.5 flex rounded-full bg-[#4cabc0] text-white font-bold">
            <PiPlantFill className="mr-2 text-[#237039] text-base" /> Revolutionary Waterless Technology
          </div>
          <div>
